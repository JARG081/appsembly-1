...
export const DeleteUserCard = ({ register, handleSubmit, handleShowForm, errors, successfulAssembly, onSubmitHelper }) => {
    return(
        <>
            {/* close card */}
            ...
            {/* card title */}
            <h1 className="text-center text-3xl">Eliminando usuario</h1>
